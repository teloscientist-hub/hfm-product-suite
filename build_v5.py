...
function home(){
  ...
  <section><div class="shell stack">
    ...
    <div class="deck" style="margin-top:10px">
      ...
      <div class="pt" style="border-color:var(--gold)"><h4>Tiers 2 and 3 are thirteen for thirteen</h4><p>Every engagement in the middle is an AI system. Tier 2 has no equivalent anywhere else in our catalogue: it is the working relationship between one person and one model, which is the most-asked question in eighteen months of live sessions and the least written down.</p></div>
      <div class="pt" style="border-color:var(--stone)"><h4>Tier 5 is five for six the other way</h4><p>Pricing, outreach, positioning and an argument against monthly billing. None of it has a model in it, none of it carries a version number, and it came out of what everybody calls the AI curriculum.</p></div>
    </div>
